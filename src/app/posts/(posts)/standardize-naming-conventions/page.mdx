...
When naming things, it is important to try to use names that are easy to understand and describes its purpose.

```ts title="descriptive-names.ts"
/* Bad */
const init = () => {
  /* Return post count */
}
